      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm space-y-4">
          <div className="w-full h-48 border-2 border-dashed border-gray-200 rounded-lg flex flex-col items-center justify-center bg-gray-50">
            ...
            <input type="file" accept="image/*" onChange={handleFileChange} className="opacity-0 absolute h-48 w-full cursor-pointer" />
          </div>
          <div>
          ...
          <button onClick={handleUpload} className="w-full bg-blue-600 text-white font-bold py-3 rounded-lg mt-4 hover:bg-blue-700 transition shadow-lg">
            Post Listing
          </button>
        </div>
      </div>
